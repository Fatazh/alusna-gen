...
export function ComponentKit({ system }: { system: DesignSystem }) {
  ...
  return (
    <div data-user-palette-preview className="contents">
      <Card>
        <CardHeader
          title="Component Kit"
          subtitle={text(
              ...
              >
                <div>
                  ...
                  <p className="text-[11px]" style={{ color: color("text-secondary") }}>
                    {system.name} · {system.mode} · {text("Spacing", "Spacing")}{" "}
                    {system.spacingBase}
              ...
              {tab === "forms" && (
                <div className="max-w-lg" style={{ display: "grid", rowGap: spacing.sectionGap }}>
                  ...
                  <div className="flex flex-wrap" style={{ gap: spacing.sectionGap }}>
                    ...
                    >
                      <span
                        className="relative block h-5 w-9 shrink-0 transition"
                        style={{
                      ...
                      >
                        <span
                          className="absolute left-0.5 top-0.5 h-4 w-4 transition-transform"
                          style={{
                            borderRadius: radii.pill,
