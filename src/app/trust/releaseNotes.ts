...
export const RELEASE_NOTES: Record<Locale, ReleaseNotes> = {
  id: {
    ...
    items: [
      ...
      "Validasi Node.js 22 mencakup 161 unit test dan 35 skenario E2E (34 lulus, 1 opsional dilewati), production build, serta audit dependensi produksi tanpa temuan kerentanan.",
  ...
  en: {
    ...
    items: [
      ...
      "Node.js 22 validation includes 161 unit tests and 35 E2E scenarios (34 passed, 1 optional skipped), a production build, and a production dependency audit with no vulnerabilities found.",
