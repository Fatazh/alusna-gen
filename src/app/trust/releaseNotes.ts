...
export const RELEASE_NOTES: Record<Locale, ReleaseNotes> = {
  id: {
    ...
    items: [
      ...
      "Slider radius Design System kini mengubah sudut preview Component Kit dan handoff CSS, Tailwind, serta React secara konsisten; radius 0 menghasilkan sudut siku, terpisah dari pilihan ukuran tombol.",
      "Unit spacing kini mengatur padding, gap, dan jarak antar bagian Component Kit serta ikut tercermin pada snippet handoff.",
      ...
      "Validasi Node.js 22 mencakup 162 unit test dan 35 skenario E2E (34 lulus, 1 opsional dilewati), production build, serta audit dependensi produksi tanpa temuan kerentanan.",
  ...
  en: {
    ...
    items: [
      ...
      "The Design System radius slider now updates Component Kit preview corners and CSS, Tailwind, and React handoff consistently; radius 0 produces square corners independently of button size.",
      "The spacing unit now controls Component Kit padding, gaps, and section spacing, and is reflected in handoff snippets.",
      "Brand Kit action messages are bilingual; CSS, JSON, SCSS, Tailwind, and React Native exports remain browser-local.",
      "Node.js 22 validation includes 162 unit tests and 35 E2E scenarios (34 passed, 1 optional skipped), a production build, and a production dependency audit with no vulnerabilities found.",
