...
export const RELEASE_NOTES: Record<Locale, ReleaseNotes> = {
  id: {
    ...
    items: [
      ...
      "Quality gate Node.js 22, 158 unit test, 33 skenario E2E (32 lulus, 1 opsional), production build, dan dependency audit dijalankan ulang untuk rilis ini.",
  ...
  en: {
    ...
    items: [
      ...
      "The Node.js 22 quality gate, 158 unit tests, 33 E2E scenarios (32 passed, 1 optional), production build, and dependency audit were rerun for this release.",
